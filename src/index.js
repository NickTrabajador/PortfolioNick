...
function footerHandler() {
  ...
  document.querySelector('.footer').innerHTML = `
    © Copyright <span>popehiflo</span>, ${currentYear}. All rights reserved Trabajo referencial.
    <p>
    © Copyright <span>NickTrabajador</span>, ${currentYear}. All rights reserved cambios y modificaciones NickTrabajador.
    .
  `;
};
...
document.getElementById('download-btn').addEventListener('click', function() {
  ...
  document.getElementById('titulo-link').click();
});
