...
function projectsHandler() {
  ...
  let backProjects = myProjects.filter(project => project.category.id === "appmovil");
  ...
  document.querySelector('.projects__filter label[for=app] span.project-amount').textContent = backProjects.length;
